...
import json
import time
url = 'https://data.gov.il/api/3/action/datastore_search?resource_id=64edd0ee-3d5d-43ce-8562-c336c24dbc1f'  
...
train_df.to_csv("pop_data.csv", index=False, encoding="utf-8-sig")